package com.dahe.picturebrowse.retrofit.cookiesync;
...
public class PersistentCookieStore implements CookieStore {
    ...
    /**
     *
     *   TODO  将cookies缓存到内存中 如果缓存过期 就重置此cookie
     *
     * @param uri
     * @param cookie
     */
...
//        Log.e("","----Cookies 存储到本地--keySet-->   "+cookies.get(cookie.getDomain()).keySet());
//        Log.e("","----Cookies 存储到本地--SerializableHttpCookie-->   "+encodeCookie(new SerializableHttpCookie(cookie)));
//        Log.e("","----Cookies 存储到本地  getName---->   "+cookie.getName());
    ...
    public List<HttpCookie> get(URI uri) {
        ...
        for (String key:cookies.keySet()){
            ...
            if (key != null && uri != null && uri.getHost() != null && uri.getHost().contains(key)){
//                Log.e("","----values---   "+cookies.get(key).values());
